...
<div class=jl-preloader>
    <div class=jl-preloader-inner><img src=images/lemon-loader.svg class=jl-mar-bottom-15>
...
<header class=jl-topbar>
    <div class="jl-logo jl-logo-big"><img src=images/logo.svg alt="Logo João Lemon UX/UI Designer"></div>
...
<div class="jl-text-light jl-bg-black jl-contact-info">
    <div class=jl-contact-info-inner>
        ...
        <p>hello@lemon.com
            <p>+55 (00) 9 9999 8888
                <div class=jl-social-links><a href=# class=jl-social><img src=images/icon-instagram.svg alt=Instagram> </a><a href=# class=jl-social><img src=images/icon-twitter.svg alt=Twitter> </a><a href=# class=jl-social><img src=images/icon-dribbble.svg alt=Dribbble></a></div>
    </div>
